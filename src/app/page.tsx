      ...
      <div style={{ padding: "2.5rem 1.5rem", background: "#1B2A4A" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem", maxWidth: "360px", margin: "0 auto" }}>
          <div style={{ display: "flex", gap: "1rem", alignItems: "flex-start", background: "rgba(255,255,255,0.05)", padding: "1rem", borderRadius: "16px", border: "1px solid #2A3F6F" }}>
            ...
            <div><p style={{ fontWeight: 700, color: "#FAF8F5", margin: "0 0 0.25rem", fontSize: "0.9rem" }}>Elige tu emocion</p><p style={{ fontSize: "0.82rem", color: "#9A7080", margin: 0 }}>Selecciona como te sientes hoy entre 8 categorias emocionales</p></div>
          </div>
          <div style={{ display: "flex", gap: "1rem", alignItems: "flex-start", background: "rgba(255,255,255,0.05)", padding: "1rem", borderRadius: "16px", border: "1px solid #2A3F6F" }}>
            ...
            <div><p style={{ fontWeight: 700, color: "#FAF8F5", margin: "0 0 0.25rem", fontSize: "0.9rem" }}>Responde preguntas guiadas</p><p style={{ fontSize: "0.82rem", color: "#9A7080", margin: 0 }}>3 preguntas personalizadas segun tu estado emocional</p></div>
          </div>
          <div style={{ display: "flex", gap: "1rem", alignItems: "flex-start", background: "rgba(255,255,255,0.05)", padding: "1rem", borderRadius: "16px", border: "1px solid #2A3F6F" }}>
            ...
            <div><p style={{ fontWeight: 700, color: "#FAF8F5", margin: "0 0 0.25rem", fontSize: "0.9rem" }}>Recibe tu reflexion</p><p style={{ fontSize: "0.82rem", color: "#9A7080", margin: 0 }}>Una reflexion calida generada por IA especialmente para ti</p></div>
          </div>
        </div>
      </div>
